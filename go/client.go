// Package reversetext provides a Go client for the Reverse Text API.
//
// For more information, visit: https://apiverve.com/marketplace/reversetext?utm_source=go&utm_medium=readme
package reversetext
...
const (
	baseURL        = "https://api.apiverve.com/v1/reversetext"
	defaultTimeout = 30 * time.Second
)

// Client is the Reverse Text API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Reverse Text API client.
...
// Execute makes a request to the Reverse Text API with typed parameters.
//
...
//   - text (required): string - Text to reverse
