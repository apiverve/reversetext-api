# Reverse Text API - Examples

This folder contains example code for using the Reverse Text API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/reversetext',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/reversetext");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/reversetext](https://docs.apiverve.com/ref/reversetext)
