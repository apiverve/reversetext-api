/*
 * Reverse Text API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Reverse Text API.
 * API Documentation: https://docs.apiverve.com/ref/reversetext
 */
    ...
    class ReverseTextExample
    {
        ...
        static async Task<JsonDocument> CallReverseTextAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { text &#x3D; &quot;Hello World&quot;, mode &#x3D; &quot;characters&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Reverse Text API...\n");

            var result = await CallReverseTextAPI();
