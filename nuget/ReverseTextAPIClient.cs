...
namespace APIVerve.API.ReverseText
{
    ...
    /// <summary>
    /// Client for the ReverseText API
    /// </summary>
    public class ReverseTextAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/reversetext";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "mode", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public ReverseTextAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ReverseTextAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ReverseTextAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ReverseTextQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ReverseTextQueryOptions options)
        {
        ...
        public ResponseObj Execute(ReverseTextQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ReverseTextQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ReverseTextQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ReverseTextQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ReverseTextQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ReverseTextQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ReverseTextQueryOptions options)
        {
