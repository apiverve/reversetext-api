...
class reversetextWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/reversetext');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/reversetext';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"text":{"type":"string","required":true},"mode":{"type":"string","required":false,"default":"characters"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/reversetext`);
        }
    }
...
module.exports = reversetextWrapper;
