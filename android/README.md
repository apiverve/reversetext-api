...
```gradle
dependencies {
    implementation 'com.github.apiverve:reversetext-api:1.1.13'
}
```
...
```java
import com.apiverve.reversetext.ReverseTextAPIClient;
import com.apiverve.reversetext.APIResponse;
import com.apiverve.reversetext.APIException;

// Initialize the client
ReverseTextAPIClient client = new ReverseTextAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "Hello World");
    parameters.put("mode", "characters");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/reversetext](https://docs.apiverve.com/ref/reversetext)
...
- **Documentation:** [https://docs.apiverve.com/ref/reversetext](https://docs.apiverve.com/ref/reversetext)
- **Issues:** [GitHub Issues](https://github.com/apiverve/reversetext-api/issues)
